...
//@ts-ignore
import { ChevronUp, ChevronDown, Play, Share2, Axis3DIcon } from "lucide-react"
...
export default function StreamView({
    ...
    useEffect(() => {
        ...
        function eventHandler(event: any) {
            ...
            if (event.data === 0) { // when video is ended 
                playNext();
            }
        };
    ...
    const playNext = async () => {
        if (queue.length > 0) {
            try {
                ...
                console.log("Error in playNext", error)
            }
